...
import com.dating.reveal.net.util.CustomMultipartEntity;
import com.dating.reveal.net.util.CustomMultipartEntity.ProgressListener;
...
public class UpLoadFileTask extends AsyncTask<String, String, String> {
	...
	public UpLoadFileTask(String uploadURL, HashMap<String, String> params, Handler handle,String uploadFileType, ResultCallBack callback) {
	...
	protected String doInBackground(String... params) {
		...
		switch (upLoadFileType){
			case "images":
				mpEntity.addPart("images", cbFile); // <input type="file"
				break;
			case "recording":
				mpEntity.addPart("myfile", cbFile); // <input type="file"
				break;
			case "uploadphoto":
				mpEntity.addPart("uploadphoto", cbFile); // <input type="file"
				break;
			default:
				return null;
		}
